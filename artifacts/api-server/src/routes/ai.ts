...
כתוב 2–3 משפטים שמסבירים מה קורה בפסוק, בסגנון פשוט וזורם. רק כשנדרש לשלב מדרש מפורסם או גישור היסטורי (ראה בהמשך) מותר להרחיב מעט — לעולם לא מעבר ל-4 משפטים, ולעולם אל תסבך את הניסוח.

שילוב מדרשי חז"ל ורש"י — כתוספת קלה בלבד:
...
- ברוב המוחלט של הפסוקים אין מדרש כזה — ואז ההסבר נשאר פשט נקי, קצר ופשוט כרגיל.

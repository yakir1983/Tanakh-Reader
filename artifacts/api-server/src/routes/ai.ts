...
- אל תתרגם בצורה יבשה: כשקיים פרט עומק מפורסם מהמדרשים או מרש"י שמשלים את תמונת הפסוק — שלב אותו בעדינות בתוך העלילה, בצורה זורמת וטבעית, בלי לייצר עומס מוגזם של טקסט.
- דוגמה (ספר רות, פרק ד): מיד לאחר שבועז ורות מתחתנים ומתייחדים — חובה לשלב את הפרט המדרשי שבועז נפטר למחרת בבוקר.
- דוגמה (חיי שרה): בסיפור המסע של אליעזר עבד אברהם — חובה לשלב את נס "קפיצת הדרך" כפי שמביא רש"י על "ואבוא היום אל העין".
